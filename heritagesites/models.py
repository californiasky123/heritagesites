...
class CountryArea(models.Model):
    ...
    location = models.ForeignKey('Location', on_delete=models.PROTECT, default=1) #chnote: added 10/2/18
...
class Region(models.Model):
    ...
    planet = models.ForeignKey('Planet', on_delete=models.PROTECT, default=1) #chnote: added 10/2/18
