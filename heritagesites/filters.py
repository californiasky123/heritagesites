...
class HeritageSiteFilter(django_filters.FilterSet):
	...
	## might need to fix heritage_site_category below --
		# is field name correct? or is it heritage_site category? 
		# do I need to join any tables here?
	...
	## will likely need to fix date_inscribed below 
	# See https://django-filter.readthedocs.io/en/master/ref/fields.html 
